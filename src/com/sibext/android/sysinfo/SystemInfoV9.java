...
@TargetApi(9)
public class SystemInfoV9 extends AbstractSystemInfo {

    @Override
    public String build() {
        StringBuilder sb = new StringBuilder("--SYSTEM V9--").append(DELIMITER);
        sb.append(getInfoFromBuildClass());
        return sb.toString();
    }

    protected StringBuilder getInfoFromBuildClass() {
